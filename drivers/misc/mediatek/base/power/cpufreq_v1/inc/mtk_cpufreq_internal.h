...
#define tag_pr_notice(fmt, args...)		do {} while (0)
#define tag_pr_info(fmt, args...)		do {} while (0)
#define tag_pr_debug(fmt, args...)		do {} while (0)
#define tag_pr_deferred(fmt, args...)   	do {} while (0)
